...
function createTable(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        for (let j = 0; j < propName.length; j++) {
            ...
            td.width = '75';
			switch(j){
				case 0 : 	td.appendChild(document.createTextNode(data[i].name)); 
							break;
				case 1 : 	td.appendChild(document.createTextNode(data[i].bestBid)); 
							break;
				case 2 : 	td.appendChild(document.createTextNode(data[i].bestAsk)); 
							break;
				case 3 : 	td.appendChild(document.createTextNode(data[i].lastChangeBid)); 		   
							break;
				default: 
